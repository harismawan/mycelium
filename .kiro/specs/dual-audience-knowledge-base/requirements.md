...
1. Mycelium SHALL provide an AGENTS.md file documenting all Agent-specific endpoints, authentication via API_Key, request and response schemas, and usage examples.
